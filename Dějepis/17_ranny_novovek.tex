...
\subsection{Válka česká -- České stavovské povstání}
...
\item porušování Majestátu
	...
	\item sněm zakázán Matyášem \ra druhý sjezd 21.5. v Karolínu (radikálové)
...
\item chyby
	\begin{itemize}
	\item spoléhají na zahraniční pomoc (Unie, Jakub I., Nizozemí, Uhersko)
	\end{itemize}
\item 20. 3. 1619 -- zemřel Matyáš
...
\end{itemize}
\item \lp{leden 1620}{se připojila uherská opozice}(Gábor Bethlen)
\end{itemize}
...
\item násilná rekatolizace
	\begin{itemize}
	\item \item univerzita pod dohledem jezuitů
	\item Majestát zrušen
	\end{itemize}
...
\item \lp{1627 Č, 1628 M}{Obnovené zřízení zemské}
	...
	\item katolicismus = jediné movolené náboženství
...
\begin{itemize}
\item jazyk a literatura 
	\begin{itemize}
	\item Jan Blahoslav, Jiří melantrich z Aventina, Daniel Adam z Veleslavína, Pavel Skála ze Zhoře, Pavel Stránský, Václav Vratislav z Mitrovic, literátská bratrstva
	\end{itemize}
...
\paragraph{I. válka česká}
\begin{itemize}
\item 1618--1620
\end{itemize}

\paragraph{II. válka falcká}(1621--1623)
\begin{itemize}
\item Císařská vojska (Johann Tilly) obsadila se španělskou pomocí Falc
\item Morava -- Jan Jiří Krnovský + Valaši
\item Uherský odboj -- Gabriel Bet hlen
\item 1622 -- Bethlen uzavřel mír s císařem
\item 1623 -- Bavorsko získalo kuřfiřstkou hodnost
\end{itemize}

\paragraph{III. válka dánská}(1625--1629)
\begin{itemize}
\item nekatoličtí stavové: Nizozemsko + Anglie, Dánsko, severní německo, F. Falcký, G. Bethlen
\item 1625 -- haagská koalice -- vedení Kristián IV.
...
\item 1627 Valdštejn zlikvidoval zbytky protihabsburského vojska na Moravě a Slezsku
\item Valdštejn vrchním velitelem císařské armády (Meklenbursko)
\item 1629 -- resttituční edikt -- navrácení majetku katolické církvi
\item 22. 5. 1629 -- mír v Lübecku
\item srpen 1629 -- Valdštejn propuštěn z císařských služeb
\end{itemize}

\paragraph{IV. válka švédská (1630--1635)}
\begin{itemize}
\item 1630 -- Gustav II. Adolf se vylodil v Pomořanech
\item 1631 -- spojenci Švédska: Sasko, Braniborsko
\item září 1631 -- bitva u Breitenfeltu (poražen Tilly)
\item Švédové vpadli do Bavorska
\item listopad 1631 -- Sasové obsadili severní Čechy a Prahu \ra dočasný návrat exilantů do Čech
\item 1632 -- Tilly padl u Rainu 
	\begin{itemize}
	\item 1632 -- povolán Valdštejn (pravomoci, nová armáda)
...
\item \lp{16.11.1632}{bitva u Lützenu} -- padl Gustav II. Adolf
	...
	\end{itemize}
\item 25. 2. 1634 -- Valdštejn zavražděn v Chebu -- nedůvěryhodný
\item září 1634 -- Švédové poraženi u nördlingenu
\item Sasové začali vyjednávat o míru
\item 30.5.1635 -- pražský separátní mír
	\begin{itemize}
...
\item 1635 -- mír Braniborsko
\end{itemize}

\paragraph{V. válka švédsko-francouzská} (1635--1648)
\begin{itemize}
\item květen 1635 -- Richelieu vypověděl válku Španělsku
\item spojenci císaře -- Sasko, Braniborsko, Dánsko
\item leden 1639 Švédové vpadli do severního Němeca
	\begin{itemize}
	\item 1642 -- Leonard Torstenson vpadl do Slezska a na Moravu
	\item 1643 -- 1. obléhání Brna
	\end{itemize}
\item Jankov 1645 -- Torstenson zvítězil
\item 4.5 -- 23. 8. 1645 -- 2. obléhání Brna 
	\begin{itemize}
